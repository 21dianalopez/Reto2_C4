function traerInformacionProductos(){
    console.log("test");
        $.ajax({
        url:"http://144.22.56.43:8080/api/productos/all",
        type:"GET",
        datatype:"JSON",
...
function borrarProducto(reference){
    ...
    $.ajax({
        url:"http://144.22.56.43:8080/api/productos/"+reference,
        type:"DELETE",
        data:dataToSend,
...
function editarProducto(id) {
    Swal.fire({
        ...
        width: 600,
        padding: '3em',
        background: '#fff url(https://www.wallpapertip.com/wmimgs/190-1900884_untitled-design-clothing.png)',
        backdrop: `
          rgba(0,0,123,0.4)
          url("https://www.wallpapertip.com/wmimgs/35-355655_image-sale-at-builders-warehouse.jpg")
          left top
          no-repeat
        `
      })
    ...
    $.ajax({
        dataType: 'json',
        url:"http://144.22.56.43:8080/api/productos/"+id,
